...
model = load_model("rock_paper_scissors_model.h5")  # change this to your model filename
labels = ["rock", "paper", "scissors", "none"]  # modify based on your classes
...
while True:
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # Extract hand ROI and preprocess for prediction
            hand_img = frame[y_min:y_max, x_min:x_max]
            if hand_img.size > 0:
                hand_img_resized = cv2.resize(hand_img, (224, 224))  # adjust to model input
